...
\begin{remark}
MetaGPT由深度求索（DeepWisdom）团队开发，核心研发来自中国团队，论文发表于ICLR 2024，是中国学者在多智能体LLM领域的重要贡献。该工作提出的SOP驱动的多智能体协作范式，对任务规划中的角色分工和流程编排具有启发意义。
\end{remark}
...
\begin{remark}
ChatDev由清华大学自然语言处理实验室（THUNLP）开发，同样是中国学术团队的重要成果。这两个系统表明，中国团队在LLM多智能体系统方向上处于国际前沿。
\end{remark}
