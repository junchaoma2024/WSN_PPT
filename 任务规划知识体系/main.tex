...
华中科技大学王红卫教授、祁超副教授等在HTN规划方面开展了系统性研究。王红卫教授是华中科技大学自动化学院长江学者特聘教授，祁超副教授是其团队核心成员，研究方向为不确定环境下的HTN规划理论与应急决策方法。
...
\begin{itemize}[leftmargin=2em]
    ...
    \item 基于HTN的应急资源协调规划方法，将协调过程嵌入HTN规划中处理分布式规划中的资源冲突
    \item 面向应急响应决策的层次任务网络规划理论与方法研究
\end{itemize}
...
王红卫、祁超团队在应急响应决策方面的研究体现了数据-模型-算法融合思想。该团队将HTN规划与应急管理领域知识相结合，提出了面向不完全信息、并发任务和不确定持续时间的应急任务规划方法：
...
\begin{enumerate}[leftmargin=2em, label={[\arabic*]}]
    ...
    % HTN规划与华中科技大学研究
    \item 王红卫, 刘典, 赵鹏, 祁超, 陈曦. 不确定层次任务网络规划研究综述[J]. 自动化学报, 2016, 42(5):655-667.
    \item 王红卫, 祁超等. 基于层次任务网络的应急资源协调规划方法[J]. 系统工程理论与实践, 2015, 35(10):2504-2511.
